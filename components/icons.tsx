...
export const YouTubeIcon: React.FC<IconProps> = ({ className }) => (
    <svg className={className} viewBox="0 0 28 20" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
        <path d="M27.355 3.056C27.039 1.854 26.075.89 24.873.574 22.702 0 14 0 14 0S5.298 0 3.127.574C1.925.89.961 1.854.645 3.056.33 4.258 0 7.425 0 10s.33 5.742.645 6.944c.316 1.202 1.28 2.166 2.482 2.482C5.298 20 14 20 14 20s8.702 0 10.873-.574c1.202-.316 2.166-1.28 2.482-2.482.315-1.202.645-4.369.645-6.944s-.33-5.742-.645-6.944z" />
...
export const EyeIcon: React.FC<IconProps> = ({ className }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" d="M2.036 12.322a1.012 1.012 0 010-.639l4.418-5.58a1.012 1.012 0 011.591 0l4.418 5.58a1.012 1.012 0 010 .639l-4.418 5.58a1.012 1.012 0 01-1.591 0l-4.418-5.58z" />
...
export const ExternalLinkIcon: React.FC<IconProps> = ({ className }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" d="M13.5 6H5.25A2.25 2.25 0 003 8.25v10.5A2.25 2.25 0 005.25 21h10.5A2.25 2.25 0 0018 18.75V10.5m-4.5 0V6.375c0-.621.504-1.125 1.125-1.125h4.25c.621 0 1.125.504 1.125 1.125V10.5m-4.5 0L19.5 5.25" />
    </svg>
);
